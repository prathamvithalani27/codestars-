  ...
  return (
    <div className="fixed top-0 left-0 right-0 p-6 flex justify-between items-center z-[100] pointer-events-none">
      ...
      <div className="pointer-events-auto flex gap-4">
        <Link href="/login" className="px-6 py-3 bg-black/40 backdrop-blur-xl border border-white/20 text-white font-bold rounded-full hover:bg-white/20 transition-all shadow-xl text-sm uppercase tracking-wider hidden sm:block">Login</Link>
