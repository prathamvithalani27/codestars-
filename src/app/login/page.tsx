  ...
  return (
    <form className="mt-8 space-y-6" action={handleSubmit}>
      ...
      <div>
        ...
        >
          {loading ? 'Entering...' : 'ENTER CODESTARS'}
        </button>
      </div>
    </form>
  )
        ...
        <div className="bg-black/60 backdrop-blur-2xl p-10 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.6)] border border-white/10 relative overflow-hidden">
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-center text-3xl font-black text-white tracking-tighter">
              Welcome back,<br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">CodeStar</span>
            </h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-zinc-500">
              New to CodeStars?{' '}
              <Link href="/register" className="font-bold text-cyan-400 hover:text-cyan-300 hover:underline underline-offset-4 transition-all">
                Create your account
              </Link>
            </p>
          </div>
